...
<head>
  ...
  <body style="background-image:url('./image/3/tempete.jpg');background-size: cover;">
  ...
  <div class="container-fluid" >
    ...
    <div class="row" >
      ...
      <div class="col-lg-2 armes parallelogrambuilder" id="composant" ><p style="transform:skewX(-20deg);">COUCOU<p></div>
