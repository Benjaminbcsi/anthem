	 ...
	 <a href="#" onclick="navigate('<?php echo encrypt('accueil','DISII28');?>');"><img src="./image/logotype.png" height="54px"></a>
				...
				<ul><li>
                       <a href="#" onclick="navigate('<?php echo encrypt('listejeu','DISII28');?>')
						...
						<ul>
							<li>
								<a href="#" onclick="navigate('<?php echo encrypt('listejeu','DISII28');?>');">ordre alphabétique</a>
							</li><!--
						 --><li>
								<a href="#" onclick="navigate('<?php echo encrypt('listejeu','DISII28');?>');">genre</a>
							</li><!--
						 --><li>
								<a href="#" onclick="navigate('<?php echo encrypt('listejeu','DISII28');?>');">ancienneté</a>
							</li>
						</ul>
                    </li><li>
                       ...
                       <a href="#" onclick="navigate('<?php echo encrypt('listemedia','DISII28');?>')
                        ;">Evennements</a>
                    </li></ul></nav>
