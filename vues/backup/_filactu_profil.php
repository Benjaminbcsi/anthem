		...
		<div>
            <form enctype="multipart/form-data" action="./controllers/controller.php"  method="post" id="form_post" name="form_post">
			 ...
			 function displayfilename(){
				...
				var nomFichier = $('#post').val().replace(/C:\\fakepath\\/i, '');
				var ext = nomFichier.substring(nomFichier.lastIndexOf('.')+1, nomFichier.length)
				 
				var arrayExtensions = ["jpg","jpeg","png","gif"];
				
				if (arrayExtensions.lastIndexOf(ext) == -1) {
        			$('#nomfichertype').text("mauvais type d'extension");	
   				}else{		
					$('#nomfichertype').text(nomFichier);						
				}; };
			 </script>
	...
	<div class="post_list">
        ...
        <div class="post_container">
            ...
            <div class="post_joueurid">
            	<p><img src="./image/capitain.png" class="img_ami img_ami_xsmall"><span>Nom de l'utilisateur :</span></p>
            	<p>29/06/2017</p>
       		</div>
             ...
             <div class="reponse_container">
                ...
                while ($row_commentaire=$resultatscomment->fetch_array(MYSQLI_ASSOC)) {
					...
					<div class="post_reponses">        
                        <p><img src="./image/capitain.png" class="img_ami img_ami_xsmall"><span><?php echo $commentaire->getPseudo();?></span>
