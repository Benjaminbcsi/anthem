	...
	<div class="center_content">
		...
		<!-- LISTING DES JEUX DE L'UTILISATEUR -->
			<div class="privat_list_container"><!--
				...
				carte vidéo
			 --><div class="privat_list" data_id="38" data_type="video"><!-- les attibuts data_* servent à la fonction d'affichage javascript -->
					<!-- bouton supprimer -->
					<div class="suppr_bt"></div>
					<!-- affichage du photo -->
					<div class="privat_cover" style="text-align: center;">
						<!-- image du photo -->
						<img src="./image/background_profil.jpg" alt="" title="">
					</div>
				</div><!--
